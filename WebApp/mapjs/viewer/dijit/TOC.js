    ...
    function (
        ...
        var _TOCNode = declare([_Widget, _Templated], {
                ...
                if (!this.rootLayerTOC.config.noLegend) {
                    if (rootLayer._tocInfos) {
                        ...
                        if (r.infos) {
                            ...
                            if (this.rootLayerTOC.config.noICON)
                                this._setIconNode(rootLayer.renderer, this.iconNode, this); //Tạm thời comment lại, dùng sau
            ...
            _createLegendNode: function (rendLeg) {
                ...
                if (this.rootLayerTOC.config.noICON)
                    this._setIconNode(rendLeg, this.iconNode, this); //Tạm thời comment lại, dùng sau
        ...
        var TOC = declare("agsjs.dijit.TOC", [_Widget, Evented], {
             ...
             * @property {Boolean} [noICON] whether to supress the automatic action regarding groups: sync parent/child layer status.
             *
             */
            /**
             * @name TOCOptions
